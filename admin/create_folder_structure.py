...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(project_root, "docs", "structure")  # Specify the output directory
    output_filename = os.path.join(output_dir, "folder_structure.txt")  # Specify the full path to the output file
